...
<ComponentPreview name="next-top-loader-demo" description="A loading bar that appears at the top during navigation" />
...
<ComponentSource name="next-top-loader" title="components/ui/next-top-loader.tsx" />

...
<ComponentPreview name="better-auth-signup-demo" description="Complete sign-up form with email and password authentication using Better Auth" />
...
```bash
npx shadcn@latest add https://ui.nowts.app/r/better-auth-signup.json
```
...
```tsx title="components/custom-signup.tsx"
"use client";

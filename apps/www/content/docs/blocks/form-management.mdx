...
<ComponentPreview name="form-management-demo" description="Comprehensive form management with auto-save, unsaved changes warning, and sticky action bar" />
...
```bash
npx shadcn@latest add https://ui.nowts.app/r/form-management.json
```
...
```bash
npx shadcn@latest add https://ui.nowts.app/r/use-debounce-fn.json https://ui.nowts.app/r/use-warn-if-unsaved-changes.json https://ui.nowts.app/r/use-is-client.json https://ui.nowts.app/r/submit-button.json
```
